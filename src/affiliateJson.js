  ...
  "How Does this website Built?": [
    {
      ...
      review: `This course focuses on efficiency and making you into a Back End or Fullstack developer using the 
...
const MainAffiliateLinks = [
  {
    headerTitleNo: "How Does this website Built Testing222?",
    headerTitle: `${"How Does this website Built Testing222".replace(
      / /g,
      "-"
    )}`,
    authorNmae: "Keanu Gaynor",
    mappedDate: new Date(2022, 5, 17),
    explainParaHow: `The front end of this website was developed with React, the back end 
    ...
    testList: MainCourseList["How Does this website Built?"],
  },
  {
    headerTitleNo: "How Does",
    headerTitle: `${"How Does this website Built Testing2".replace(/ /g, "-")}`,
    authorNmae: "Keanu Gaynor",
    mappedDate: new Date(2022, 5, 17),
    explainParaHow: `The front end of this website was developed with React, the back end 
    with Node JS, and the sentiment analysis was done with Python Fastapi. 
  ...
  {
    headerTitleNo: "How Does this website Built Testing2442?",
    headerTitle: `${"How Does this website Built Testing3".replace(/ /g, "-")}`,
    authorNmae: "Keanu Gaynor",
    mappedDate: new Date(2022, 5, 17),
    explainParaHow: `The front end of this website was developed with React, the back end 
    with Node JS, and the sentiment analysis was done with Python Fastapi. 
...
export { MainAffiliateLinks, MainCourseList };
